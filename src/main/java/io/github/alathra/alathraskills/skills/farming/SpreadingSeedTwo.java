...
public class SpreadingSeedTwo extends Skill {

    private static double SPREADING_SEED_TWO_CHANCE = 0.30;
    private SkillsManager skillsManager;

    public SpreadingSeedTwo(int id, String name, String description) {
        super(id, "Spreading Seed 2", "Get a chance to sow seeds in a wider area!");
    ...
    public static void run (Block initialCrop, Player player) {
        if (Math.random() >= SPREADING_SEED_TWO_CHANCE)
            return;
