...
public class TrimmerSix extends Skill {

    private SkillsManager skillsManager;

    public TrimmerSix(int id, int cost) {
        super(id, "Trimmer 6", "Your ax cuts straight through leaves and you can find apples on the branches of all trees.", cost);

        ItemStack icon = new ItemStack(Material.OAK_LEAVES, 6);
