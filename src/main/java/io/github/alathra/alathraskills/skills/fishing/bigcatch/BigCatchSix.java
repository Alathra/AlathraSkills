...
public class BigCatchSix extends Skill {
    public BigCatchSix(int id, int cost) {
        super(id, "Big Catch 6", "Sometimes you catch two fish instead of one.", cost);

        ItemStack icon = new ItemStack(Material.COD, 6);
