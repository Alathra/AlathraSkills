...
public class ALongFightThree extends Skill {
    public ALongFightThree(int id, int cost) {
        super(id, "A Long Fight 3", "You get extra time in the fishing minigames.", cost);

        ItemStack icon = new ItemStack(Material.CLOCK, 3);
