...
public class FastHarvestOne extends Skill {
    ...
    public FastHarvestOne(int id, int cost) {
        super(id, "Fast Harvest 1", "Break multiple crops at once in a radius. Only applies fortune on the crop hit with the hoe.", cost);
