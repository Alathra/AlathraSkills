package io.github.alathra.alathraskills.skills.fishing.quicktobite;
...
public class QuickToBiteThree extends Skill {
    public QuickToBiteThree(int id, int cost) {
        super(id, "Quick To Bite 3", "It takes less time for a fish to bite.", cost);

        ItemStack icon = new ItemStack(Material.FISHING_ROD, 3);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 13").build().decoration(TextDecoration.ITALIC, false));
