...
public class BigCatchThree extends Skill {
    public BigCatchThree(int id, int cost) {
        super(id, "Big Catch 3", "Sometimes you catch two fish instead of one.", cost);

        ItemStack icon = new ItemStack(Material.COD, 3);
