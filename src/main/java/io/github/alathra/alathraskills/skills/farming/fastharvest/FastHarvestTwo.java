...
public class FastHarvestTwo extends Skill {
    ...
    public FastHarvestTwo(int id, int cost) {
        super(id, "Fast Harvest 2", "Break multiple crops at once in a radius. Only applies fortune on the crop hit with the hoe.", cost);
