...
public class ALongFightSix extends Skill {
    public ALongFightSix(int id, int cost) {
        super(id, "A Long Fight 6", "You get extra time in the fishing minigames.", cost);

        ItemStack icon = new ItemStack(Material.CLOCK, 6);
