...
public class HighQualityCatchFive extends Skill {
    public HighQualityCatchFive(int id, int cost) {
        super(id, "High Quality Catch 5", "You have a higher chance to catch uncommon, semi-rare, and rare fish.", cost);

        ItemStack icon = new ItemStack(Material.TROPICAL_FISH, 5);
