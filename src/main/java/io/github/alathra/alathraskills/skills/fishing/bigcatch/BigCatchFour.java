package io.github.alathra.alathraskills.skills.fishing.bigcatch;
...
public class BigCatchFour extends Skill {
    public BigCatchFour(int id, int cost) {
        super(id, "Big Catch 4", "Sometimes you catch two fish instead of one.", cost);

        ItemStack icon = new ItemStack(Material.COD, 4);
