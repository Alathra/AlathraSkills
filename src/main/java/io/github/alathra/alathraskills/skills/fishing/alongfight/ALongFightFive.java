...
public class ALongFightFive extends Skill {
    public ALongFightFive(int id, int cost) {
        super(id, "A Long Fight 5", "You get extra time in the fishing minigames.", cost);

        ItemStack icon = new ItemStack(Material.CLOCK, 5);
