...
public class WideSpreadFive extends Skill {

    public WideSpreadFive(int id, int cost) {
        super(id, "Wide Spread 5", "Seeds plant in a radius. Must have enough seeds in your inventory to fill the area you are planting.", cost);

        ItemStack icon = new ItemStack(Material.WHEAT_SEEDS, 5);
