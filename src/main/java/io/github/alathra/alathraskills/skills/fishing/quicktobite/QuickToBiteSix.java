...
public class QuickToBiteSix extends Skill {
    public QuickToBiteSix(int id, int cost) {
        super(id, "Quick To Bite 6", "It takes less time for a fish to bite.", cost);

        ItemStack icon = new ItemStack(Material.FISHING_ROD ,6);
