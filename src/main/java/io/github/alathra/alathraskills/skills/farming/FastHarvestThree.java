...
public class FastHarvestThree extends Skill {
    ...
    private static double FAST_HARVEST_THREE_CHANCE = 0.70;
    private SkillsManager skillsManager;

    public FastHarvestThree(int id, String name, String description) {
        super(id, "Fast Harvest 3", "Get a chance to harvest crops in a wider area!");
    ...
    public static void run(Block initialCrop, Player player) {
        if (Math.random() >= FAST_HARVEST_THREE_CHANCE)
            return;
