...
public class ALongFightTwo extends Skill {
    public ALongFightTwo(int id, int cost) {
        super(id, "A Long Fight 2", "You get extra time in the fishing minigames.", cost);

        ItemStack icon = new ItemStack(Material.CLOCK, 2);
