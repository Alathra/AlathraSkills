...
public class QuickToBiteTwo extends Skill {
    public QuickToBiteTwo(int id, int cost) {
        super(id, "Quick To Bite 2", "It takes less time for a fish to bite.", cost);

        ItemStack icon = new ItemStack(Material.FISHING_ROD, 2);
