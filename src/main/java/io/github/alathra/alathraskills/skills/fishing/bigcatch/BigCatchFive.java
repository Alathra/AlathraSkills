...
public class BigCatchFive extends Skill {
    public BigCatchFive(int id, int cost) {
        super(id, "Big Catch 5", "Sometimes you catch two fish instead of one.", cost);

        ItemStack icon = new ItemStack(Material.COD, 5);
