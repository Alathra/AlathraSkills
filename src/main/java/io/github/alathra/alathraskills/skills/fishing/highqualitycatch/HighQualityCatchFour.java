...
public class HighQualityCatchFour extends Skill {
    public HighQualityCatchFour(int id, int cost) {
        super(id, "High Quality Catch 4", "You have a higher chance to catch uncommon, semi-rare, and rare fish.", cost);

        ItemStack icon = new ItemStack(Material.TROPICAL_FISH, 4);
