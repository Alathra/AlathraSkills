...
public class BigCatchOne extends Skill {
    public BigCatchOne(int id, int cost) {
        super(id, "Big Catch 1", "Sometimes you catch two fish instead of one.", cost);

        ItemStack icon = new ItemStack(Material.COD);
