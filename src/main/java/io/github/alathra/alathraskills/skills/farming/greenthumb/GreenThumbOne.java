...
public class GreenThumbOne extends Skill {

    public GreenThumbOne(int id, int cost) {
        super(id, "Green Thumb 1", "Bone meal applies to multiple crops in a radius.", cost);
