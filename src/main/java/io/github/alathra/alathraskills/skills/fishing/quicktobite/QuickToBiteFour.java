...
public class QuickToBiteFour extends Skill {
    public QuickToBiteFour(int id, int cost) {
        super(id, "Quick To Bite 4", "It takes less time for a fish to bite.", cost);

        ItemStack icon = new ItemStack(Material.FISHING_ROD, 4);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 15").build().decoration(TextDecoration.ITALIC, false));
