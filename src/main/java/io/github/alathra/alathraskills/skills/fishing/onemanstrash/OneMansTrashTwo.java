...
public class OneMansTrashTwo extends Skill {
    public OneMansTrashTwo(int id, int cost) {
        super(id, "One Man's Trash 2", "Sometimes you fish up bait with your fish.", cost);

        ItemStack icon = new ItemStack(Material.PAPER, 2);
