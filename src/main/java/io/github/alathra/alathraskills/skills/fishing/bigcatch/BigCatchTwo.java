...
public class BigCatchTwo extends Skill {
    public BigCatchTwo(int id, int cost) {
        super(id, "Big Catch 2", "Sometimes you catch two fish instead of one.", cost);

        ItemStack icon = new ItemStack(Material.COD, 2);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 9").build().decoration(TextDecoration.ITALIC, false));
