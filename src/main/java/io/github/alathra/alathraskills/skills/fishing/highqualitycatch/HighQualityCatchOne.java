...
public class HighQualityCatchOne extends Skill {
    public HighQualityCatchOne(int id, int cost) {
        super(id, "High Quality Catch 1", "You have a higher chance to catch uncommon, semi-rare, and rare fish.", cost);

        ItemStack icon = new ItemStack(Material.TROPICAL_FISH);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 2").build().decoration(TextDecoration.ITALIC, false));
