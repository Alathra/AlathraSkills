...
public class VeinBreakerFour extends Skill {

    public VeinBreakerFour(int id, int cost) {
        super(id, "Vein Breaker 4", "Sometimes you mine the entire vein of an ore by breaking just one ore.", cost);
