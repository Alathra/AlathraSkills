...
public class PreciseChopOne extends Skill {

    public PreciseChopOne(int id, int cost) {
        super(id, "Precise Chop 1", "Sometimes you gain more logs from cutting trees down.", cost);
