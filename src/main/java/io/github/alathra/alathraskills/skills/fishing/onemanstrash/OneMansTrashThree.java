...
public class OneMansTrashThree extends Skill {
    public OneMansTrashThree(int id, int cost) {
        super(id, "One Man's Trash 3", "Sometimes you fish up bait with your fish.", cost);

        ItemStack icon = new ItemStack(Material.PAPER, 3);
