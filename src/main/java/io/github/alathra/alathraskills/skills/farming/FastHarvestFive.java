...
public class FastHarvestFive extends Skill {
    ...
    private static double FAST_HARVEST_FIVE_CHANCE = 0.40;
    private SkillsManager skillsManager;

    public FastHarvestFive(int id, String name, String description) {
    ...
    public static void runFastHarvestOne(Block initialCrop, Player player) {
        if (Math.random() >= FAST_HARVEST_FIVE_CHANCE)
            return;
