...
public class SpreadingSeedFive extends Skill {

    private static double SPREADING_SEED_FIVE_CHANCE = 0.40;
    private SkillsManager skillsManager;

    public SpreadingSeedFive(int id, String name, String description) {
        super(id, "Spreading Seed 5", "Get a chance to sow seeds in a wider area!");
    ...
    public static void run (Block initialCrop, Player player) {
        if (Math.random() >= SPREADING_SEED_FIVE_CHANCE)
            return;
