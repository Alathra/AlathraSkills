...
public class HighQualityCatchSix extends Skill {
    public HighQualityCatchSix(int id, int cost) {
        super(id, "High Quality Catch 6", "You have a higher chance to catch uncommon, semi-rare, and rare fish.", cost);

        ItemStack icon = new ItemStack(Material.TROPICAL_FISH, 6);
