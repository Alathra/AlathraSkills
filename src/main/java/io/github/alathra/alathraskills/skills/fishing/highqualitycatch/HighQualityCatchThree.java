...
public class HighQualityCatchThree extends Skill {
    public HighQualityCatchThree(int id, int cost) {
        super(id, "High Quality Catch 3", "You have a higher chance to catch uncommon, semi-rare, and rare fish.", cost);

        ItemStack icon = new ItemStack(Material.TROPICAL_FISH, 3);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 11").build().decoration(TextDecoration.ITALIC, false));
