...
public class QuickToBiteOne extends Skill {
    public QuickToBiteOne(int id, int cost) {
        super(id, "Quick To Bite 1", "It takes less time for a fish to bite.", cost);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 3").build().decoration(TextDecoration.ITALIC, false));
