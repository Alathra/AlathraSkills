...
public class FastHarvestTwo extends Skill {

    private static double FAST_HARVEST_TWO_CHANCE = 0.40;
    private SkillsManager skillsManager;

    public FastHarvestTwo(int id, String name, String description) {
        super(id, "Fast Harvest 2", "Get a chance to harvest crops in a wider area!");
    ...
    public static void run(Block initialCrop, Player player) {
        if (Math.random() >= FAST_HARVEST_TWO_CHANCE)
            return;
