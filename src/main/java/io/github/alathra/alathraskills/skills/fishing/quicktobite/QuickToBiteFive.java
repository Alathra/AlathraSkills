...
public class QuickToBiteFive extends Skill {
    public QuickToBiteFive(int id, int cost) {
        super(id, "Quick To Bite 5", "It takes less time for a fish to bite.", cost);

        ItemStack icon = new ItemStack(Material.FISHING_ROD ,5);
        ...
        loreList.add(ColorParser.of(GuiHelper.LORETEXT + "Level 18").build().decoration(TextDecoration.ITALIC, false));
