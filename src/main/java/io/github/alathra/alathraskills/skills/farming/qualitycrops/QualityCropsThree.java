...
public class QualityCropsThree extends Skill {

    private SkillsManager skillsManager;

    public QualityCropsThree(int id, int cost) {
        super(id, "Quality Crops 3", "Chance to have a second baby animal spawn when breeding animals.", cost);
