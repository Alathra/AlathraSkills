...
//    id("io.papermc.paperweight.userdev") version "1.5.9" // Used to develop internal plugins using Mojang mappings, See https://github.com/PaperMC/paperweight
    id("org.flywaydb.flyway") version "10.11.0" // Database migrations
...
dependencies {
    ...
    library("org.flywaydb:flyway-core:10.11.0")
    library("org.flywaydb:flyway-mysql:10.11.0")
    library("org.flywaydb:flyway-database-hsqldb:10.11.0")
